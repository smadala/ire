...
public class ExternalSort {
	...
	*/
	public static void createOffsetsFile(String indexFile, String offsetsFileDir,int offsetFilePrefix){
		...
		try{
			File wordsFile=new File(offsetsFileDir,offsetFilePrefix+ParsingConstants.OFFSET_SUFFIX);
			File secondryIndex=new File(offsetsFileDir,offsetFilePrefix+ParsingConstants.SECONDRY_SUFFIX);
            ...
            int lineNumber=0;
            //String words[];
            String wordDelimiter=ParsingConstants.WORD_IDF_DELIMITER+"";
            String offsetLine;
            ...
            while( (line = br.readLine()) != null ){
            	 ...
            	 if(lineNumber++ % ParsingConstants.SECONDRY_INDEX_GAP == 0 ){
